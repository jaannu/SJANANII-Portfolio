      ...
      <div className="container mx-auto px-6 relative z-10">
        <FadeIn>
          <div className="text-center mb-16">
            <span className="text-accent font-medium tracking-wider uppercase text-sm">Technical Expertise</span>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, skillIndex) => (
                    <motion.span
                      key={skillIndex}
                      className="px-3 py-1.5 text-sm rounded-full bg-secondary/80 text-secondary-foreground border border-border/50 hover:border-accent/50 transition-colors cursor-default"
